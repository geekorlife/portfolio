    ...
    render(){
        ...
        return (
            <footer>
                <ul>
                    <li>
                        <a href="https://github.com/geekorlife">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/pascal-boudier-b7555221/en">
                            <svg style={{width:'24px',height:'24px'}} viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="https://www.facebook.com/pascal.boudier">
                            <svg style={{width:'24px',height:'24px'}} viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="https://www.twitter.com/geekorlife">
                            <svg style={{width:'24px',height:'24px'}} viewBox="0 0 24 24">
